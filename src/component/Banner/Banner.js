...
export default function Banner() {
  ...
  function getData() {
    BannerService.getList(dataFill).then((response) => {
  ...
  function handleSave(data, index) {
    ...
    BannerService.bannerUpdate(IdUpdate, dataSave).then((res) => {
      if (res.status === 200) {
      ...
      <div className="container-fluid">
        <div className="d-block d-xl-flex" style={{ height: "150px" }}>
          <div className="tcol-50 tcol-lg-100 d-flex flex-column justify-content-between">
            <h4 className="font-weight-bold mt-5">Banner list</h4>
                        ...
                        <tr key={index}>
                          ...
                          <td className="text-left tcol-40">
                            {editItem == index ? (
                              ...
                              <>
                                <img src={item.logo} className="img-css" />
                              </>
                            )}
                          </td>
                          <td className="text-center">
