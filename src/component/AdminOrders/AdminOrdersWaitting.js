...
export default function AdminOrdersWaitting() {
  ...
  function PaidOrder(id) {
    swal(SwalCommon.ALERT_QUESTION_CONFIRM).then((event) => {
      if (event) {
        ...
        OrdersService.OrderShip(id, setToStatus)
          .then((response) => {
            if (response.status === 200) {
              swal(SwalCommon.ALERT_CONFIRM).then(() => {
      ...
      <div className="container-fluid">
        <div className="d-block d-xl-flex">
          <div className="tcol-25 tcol-lg-100 d-flex flex-column justify-content-between">
            <h4 className="font-weight-bold mt-5"> Order waitting</h4>
